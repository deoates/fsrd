...
function toolbox_setup() {
	...
	set_post_thumbnail_size(275, 453, true);
	...
	register_nav_menus( array(
		'designs' => __( 'Design Menu', 'toolbox' ),
	) );
	register_nav_menus( array(
		'press' => __( 'Press menu', 'toolbox' ),
	) );
...
global $menu;
	$restricted = array(__('Dashboard'), __('Tools'), __('Users'), __('Settings'), __('Comments'));
	end ($menu);
	while (prev($menu)){
